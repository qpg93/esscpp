// the switch statement of section1.4 displays a different consolation message
// based on the number of wrong guesses
// replace this with an array of four string messages
// that can be indexed based on the number of wrong guesses
